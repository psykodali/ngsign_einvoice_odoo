  ...
  "API_INPUT_OBJECTS": {
    ...
    "TEIFInvoice": {
      ...
      "fields": {
        ...
        "invoiceDate": "Long | Required | Issuance timestamp (milliseconds).",
        ...
        "taxes": "List<Tax> | Optional | Global list of taxes applied.",
        ...
        "tvaRate": "Float | Optional | Global VAT Rate (if uniform).",
        "tvaTax": "BigDecimal | Optional | Global VAT Amount.",
...
# NGSIGN SEAL examples
{
    "invoices": [
        {
            "invoiceFileB64": PDFBase64,
            "type": "I-11",
            "configuration": {
                "qrPositionX": 150,
                "qrPositionY": 1,
            ...
            "invoiceTIEF": {
                "clientIdentifier": "1297689XAM000",
                "clientDetails": {
                    "partnerIdentifier": "1297689XAM000",
                    "partnerName": "Client email",
                    "address": {
                    ...
                    "partnerReference": "OM31"
                },
                "documentIdentifier": "D134552-2",
                "documentReferences": [],
                "documentType": "I-11",
                "invoiceDate": 1754348400000,
                "comments": null,
                "items": [
                    {
               ...
               "taxes": [
                ...
                "invoiceTotalWithoutTax": 419.859,
                "invoiceTotalWithTax": 504.426,
                "invoiceTotalTax": 84.568,
                "invoiceTotalinLetters": "Cinq cent quatre dinars et 426 millimes",
                "stampTax": 1.0,
                "tvaRate": 0.0,
                "tvaTax": 0.0,
                "totalDiscount": 73.919,
                "amountExempt": null,
                "currencyIdentifier": "TND",
                "paymentDetails": []
            },
            "clientEmail": "ferjani2@ng-sign.com"
        }
    ],

    "passphrase": "123456",
    "notifyOwner": true,
    "ccEmail": "support@yopmail.com"
}